...
export default function CreateAdminPage() {
  ...
  const onSubmit = async (values: AddAdminFormValues) => {
    ...
    if (success) {
      ...
      form.reset();
      router.push('/admin'); // Redirect to admin panel to see the new user
    }
  ...
  return (
    <div className="space-y-8 max-w-2xl mx-auto">
        <div className="flex items-center gap-4">
            ...
            <div>
                <h1 className="text-3xl font-bold tracking-tight font-headline">Create Admin User</h1>
                <p className="text-muted-foreground">Create a new user with administrative privileges.</p>
            </div>
        </div>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        This will create a brand new user account with an email, password, and admin role.
                    </CardDescription>
                </CardHeader>
